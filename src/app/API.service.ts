...
export type __SubscriptionContainer = {
  onCreateChatty: OnCreateChattySubscription;
  onUpdateChatty: OnUpdateChattySubscription;
  onDeleteChatty: OnDeleteChattySubscription;
};
...
export type ModelChattyConnection = {
  __typename: "ModelChattyConnection";
  items: Array<Chatty | null>;
...
export class APIService {
  ...
  OnCreateChattyListener: Observable<
    SubscriptionResponse<Pick<__SubscriptionContainer, "onCreateChatty">>
  > = API.graphql(
    graphqlOperation(
  ...
  OnUpdateChattyListener: Observable<
    SubscriptionResponse<Pick<__SubscriptionContainer, "onUpdateChatty">>
  > = API.graphql(
    graphqlOperation(
  ...
  OnDeleteChattyListener: Observable<
    SubscriptionResponse<Pick<__SubscriptionContainer, "onDeleteChatty">>
  > = API.graphql(
    graphqlOperation(
